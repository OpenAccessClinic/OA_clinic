...
[**Open science is good for your career!**](http://whyopenresearch.org/)   
* Try to publish in an open access journal.
* Share all your scholarly outputs (including data and code) via on-line repositories.
* If you have to or have published in non open access journals follow the steps below to make them open access anyway.  

---   

# <img src="{{ site.baseurl }}/img/icons/find.png" width="10%" alt="Find">  <a name="find"></a> 1) Find your work
...
<a href="https://orcid.org/0000-0003-3768-4269"> <img src="{{ site.baseurl }}/img/my_orcid_qrcode.png" width="10%" alt="Find"> </a>

[*Back to top*](#top)   

---

# <img src="{{ site.baseurl }}/img/icons/rights.png" width="10%" alt="rights"> <a name="rights"></a> 2) Check your permissions and rights
...
# <img src="{{ site.baseurl }}/img/icons/upload.png" width="10%" alt="upload"> <a name="upload"></a> 3) Upload your work  
1. Gather your works
...
# <img src="{{ site.baseurl }}/img/icons/award.png" width="10%" alt="award"> <a name="award"></a> 4) Get recognition, be discovered, and get rewarded for your open access efforts.  
